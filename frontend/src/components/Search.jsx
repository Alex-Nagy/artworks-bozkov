  ...
  return (
    <div>
      <form className="searchForm" onSubmit={(e) => {
        ...
        <input type="text" name="search" className="searchInput" placeholder="search (title, artist, description, classification, culture, worktype)" value={searchString} onChange={(e) => setSearchString(e.target.value)}/>
